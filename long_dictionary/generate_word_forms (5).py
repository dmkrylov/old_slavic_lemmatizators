    ...
    for gramm_form, endings in zip(paradigm_head, paradigms[paradigm]['flex'].split('\t')):
        ...
        for variant_no, ending in enumerate(endings, 1):
            ...
            if re.match(r'^=.*', ending):
                ...
                form = ending
                do_update = False
            elif re.match(r'^[1-9].*', ending) and re.search(r'\$', ending):
...
forms = generate_forms_and_print("радонежскiй","A1k")
...
#forms = generate_forms_and_print("припѣвати","V11a")
