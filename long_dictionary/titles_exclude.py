...
with open("titles.txt",'r',encoding='utf8') as tildas:
	tildas = tildas.read().split()
clean_list = []
rt='с̑'[1]
qt='҃'
def kill_tilda (word):
...
with open('untitled.txt', 'w', encoding='utf8') as untitled:
